        ...
        {isLoading ? (
          <div className="flex items-center justify-center h-full">
            <div className="text-center">
              ...
              <p className="text-gray-400">Generating {selectedType === 'form' ? 'form' : selectedType === 'ppt' ? 'presentation' : selectedType === 'spreadsheet' ? 'spreadsheet' : ''}...</p>
            </div>
          </div>
        ) : schema?.googleFormId ? (
          <iframe
          ...
          <div className="text-gray-400 text-center mt-20">
            ...
            <p className="text-sm">
              Start by describing the {selectedType === 'form' ? 'form' : selectedType === 'ppt' ? 'presentation' : 'spreadsheet'} you want to create
            </p>
          </div>
        )}
      </div>
